...
# Configurações PWA
app.config['SEND_FILE_MAX_AGE_DEFAULT'] = 0  # Desativa cache
...
def generate_response(text):
    ...
    # Se não houver resposta pré-programada, usar resposta padrão
    return random.choice(RESPONSES["default"])

if __name__ == '__main__':
    # Usar IP fixo 0.0.0.0 para permitir conexões externas
